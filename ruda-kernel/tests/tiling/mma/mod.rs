...
use ruda_kernel::dsl::ir::MatrixIdent;
...
pub fn print_mma_layout<AB: RudaElement + Numeric, CD: RudaElement + Numeric>(
    m: usize,
    n: usize,
    k: usize,
    ident: MatrixIdent,
    ...
    match ident {
        MatrixIdent::A | MatrixIdent::B => {
            mma_layout_kernel::launch::<AB, CD, AB, TestRuntime>(
                ...
                RudaDim::new_1d(client.properties().hardware.plane_size_max),
