...
use ruda_kernel::dsl::server::CopyDescriptor;
use ruda_kernel::library::tensor::TensorHandle;
use ruda_test_runtime::TestRuntime;
use ruda_kernel::dsl::zspace::shape;
use ruda_kernel::quantization::{scheme::QuantMode, scheme::QuantScheme, scheme::QuantStore, scheme::QuantValue};
...
fn test_quantization_tensor_symmetric(m: usize, n: usize, value: QuantValue) {
    ...
    let [output_alloc, output_scale_alloc] = client
        .empty_tensors(vec![
            ruda_kernel::dsl::server::MemoryLayoutDescriptor {
                strategy: ruda_kernel::dsl::server::MemoryLayoutStrategy::Contiguous,
    ...
    ruda_kernel::quantization::dequantize::launch_ref(
        &client,
