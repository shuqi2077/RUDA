use crate::library::event::{ComptimeEventBus, EventListener, EventListenerExpand};
    ...
    () => {
        mod event {
            ...
            fn test_1() {
                ...
                ruda_kernel::library::tests::event::event_test_1(client);
            }

            #[$crate::library::tests::test_log::test]
            fn test_2() {
                let client = TestRuntime::client(&Default::default());
                ruda_kernel::library::tests::event::event_test_2(client);
            }

            #[$crate::library::tests::test_log::test]
            fn test_3() {
                let client = TestRuntime::client(&Default::default());
                ruda_kernel::library::tests::event::event_test_3(client);
            }
        }
    };
}
