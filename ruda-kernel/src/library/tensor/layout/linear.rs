...
use ruda_kernel::dsl::{ir::UIntKind, unexpanded, zspace::Shape};
...
///
/// `Layout` version of [`crate::library::tensor::contiguous::index_offset_contiguous()`]
...
impl ViewLayoutLaunchArg for LinearViewLayout {
    ...
    fn expand(
        ...
        ty: Type,
        builder: &mut crate::dsl::prelude::KernelBuilder,
    ) -> <Self as crate::dsl::prelude::RudaType>::ExpandType {
