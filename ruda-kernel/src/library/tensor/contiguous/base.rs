...
pub fn copy_gpu_ref<R: Runtime>(
    ...
    let ruda_dim = RudaDim::new(client.properties(), num_vecs);
    let simul_vecs = num_sm * ruda_dim.num_elems();
    ...
    let ruda_count = calculate_ruda_count_elemwise(
        client,
