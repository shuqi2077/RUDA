...
/// location.
#[derive(Clone)]
pub struct View<E: RudaPrimitive, C: Coordinates, IO: Clone = ReadOnly> {
    _layout: PhantomData<C>,
    _ty: PhantomData<(E, IO)>,
}

// `View` is a dummy type so it's always send/sync
unsafe impl<E: RudaPrimitive, C: Coordinates, IO: Clone> Send for View<E, C, IO> {}
unsafe impl<E: RudaPrimitive, C: Coordinates, IO: Clone> Sync for View<E, C, IO> {}
impl<E: RudaPrimitive, C: Coordinates, IO: Clone> Copy for View<E, C, IO> {}

#[derive(Clone)]
pub(super) enum ViewType<E: RudaPrimitive, C: Coordinates> {
    Read(Arc<dyn ViewOperationsExpand<E, C>>),
    ReadWrite(Arc<dyn ViewOperationsMutExpand<E, C>>),
}

impl<E: RudaPrimitive, C: Coordinates> ViewType<E, C> {
...
/// Expand type of [`View`]
#[derive(Clone)]
pub struct ViewExpand<E: RudaPrimitive, C: Coordinates, IO: Clone = ReadOnly> {
    pub(super) inner: ViewType<E, C>,
    pub(super) _io: PhantomData<IO>,
}

impl<E: RudaPrimitive, C: Coordinates, IO: Clone> RudaType for View<E, C, IO> {
    type ExpandType = ViewExpand<E, C, IO>;
}

impl<E: RudaPrimitive, C: Coordinates, IO: Clone> IntoMut for ViewExpand<E, C, IO> {
    fn into_mut(self, _scope: &mut Scope) -> Self {
        self
    }
}

impl<E: RudaPrimitive, C: Coordinates, IO: Clone> RudaDebug for ViewExpand<E, C, IO> {}

impl<E: RudaPrimitive, C: Coordinates + 'static> View<E, C, ReadOnly> {
...
impl<E: RudaPrimitive, C: Coordinates + 'static, IO: Clone + 'static> View<E, C, IO> {
...
impl<E: RudaPrimitive, C: Coordinates + 'static, IO: Clone + 'static> ViewExpand<E, C, IO> {
...
impl<E: RudaPrimitive, C: Coordinates + 'static> View<E, C, ReadWrite> {
...
impl<E: RudaPrimitive, C: Coordinates + 'static> ViewExpand<E, C, ReadWrite> {
...
impl<E: RudaPrimitive, C: Coordinates, IO: Clone> View<E, C, IO> {
...
impl<E: RudaPrimitive, C: Coordinates, IO: Clone> ViewExpand<E, C, IO> {
...
#[allow(unused_variables)]
impl<E: RudaPrimitive, C: Coordinates> View<E, C, ReadWrite> {
...
impl<E: RudaPrimitive, C: Coordinates> ViewExpand<E, C, ReadWrite> {
...
impl<E: RudaPrimitive, C: Coordinates + 'static, IO: SliceVisibility> View<E, C, IO> {
