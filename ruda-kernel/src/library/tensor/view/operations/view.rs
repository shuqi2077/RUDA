...
use crate::library::tensor::{View, ViewExpand};
use crate::dsl::prelude::*;
use ruda_kernel::dsl::{prelude::barrier::BarrierExpand};

impl<T: RudaPrimitive, C: Coordinates, IO: Clone> Vectorized for View<T, C, IO> {}
impl<T: RudaPrimitive, C: Coordinates, IO: Clone> VectorizedExpand for ViewExpand<T, C, IO> {
    fn vector_size(&self) -> VectorSize {
        ViewExpand::vector_size(self)
    }
}

impl<T: RudaPrimitive, C: Coordinates, IO: Clone> ViewOperations<T, C> for View<T, C, IO> {}
impl<T: RudaPrimitive, C: Coordinates, IO: Clone> ViewOperationsExpand<T, C>
...
impl<T: RudaPrimitive, C: Coordinates> ViewOperationsMut<T, C> for View<T, C, ReadWrite> {}
impl<T: RudaPrimitive, C: Coordinates> ViewOperationsMutExpand<T, C>
