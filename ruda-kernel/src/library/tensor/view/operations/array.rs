...
macro_rules! impl_operations_1d {
    ($ty: ty, $expand: ty) => {
        impl<T: RudaPrimitive> ViewOperations<T, Coords1d> for $ty {}
        impl<T: RudaPrimitive> ViewOperationsExpand<T, Coords1d> for $expand {
        ...
        impl<T: RudaPrimitive> ViewOperationsMut<T, Coords1d> for $ty {}
        impl<T: RudaPrimitive> ViewOperationsMutExpand<T, Coords1d> for $expand {
