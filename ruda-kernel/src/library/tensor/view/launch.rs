...
mod layout {
    ...
    use crate::library::tensor::layout::LayoutExpand;
    ...
    /// this trait.
    pub trait ViewLayoutLaunchArg: RudaType + Send + Sync + 'static {
    ...
    impl<L: Layout + ViewLayoutLaunchArg> Deref for ConcreteLayoutExpand<L> {
        type Target = <L as RudaType>::ExpandType;
...
mod dynamic {
    ...
    impl<E: RudaPrimitive, C: Coordinates + 'static, IO: SliceVisibility> LaunchArg for View<E, C, IO> {
