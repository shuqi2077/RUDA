...
use ruda_core::ir::{Id, Scope, StorageType, Type};
use ruda::runtime::{
    kernel::{KernelArg, KernelDefinition, KernelOptions, ScalarKernelArg, Visibility},
    server::RudaDim,
};

use crate::dsl::prelude::AddressType;
...
impl KernelSettings {
    ...
    /// Set cluster dim
    pub fn cluster_dim(mut self, cluster_dim: RudaDim) -> Self {
...
impl KernelIntegrator {
    ...
    #[cfg_attr(feature = "frontend-tracing", tracing::instrument(level = "trace", skip(self)))]
