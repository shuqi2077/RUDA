...
use ruda_core::ir::{Allocator, Instruction, ManagedVariable, Operation, Operator, Processor, Scope};
use ruda::runtime::server::ExecutionMode;
...
impl Processor for CheckedIoProcessor {
    fn transform(
        &self,
        processing: ruda_core::ir::ScopeProcessing,
        allocator: Allocator,
    ) -> ruda_core::ir::ScopeProcessing {
        match self.mode {
...
impl CheckedIoProcessor {
    fn transform_checked(
        &self,
        mut processing: ruda_core::ir::ScopeProcessing,
        allocator: Allocator,
    ) -> ruda_core::ir::ScopeProcessing {
