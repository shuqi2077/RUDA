...
/// # Example
///
/// If you use [u32] as key that may become [`crate::dsl::frontend::NativeExpand<u32>`] during the expansion, both types
...
impl<K: PartialOrd + Ord + core::fmt::Debug, V: RudaType + Clone> Registry<K, V> {
...
impl<K: PartialOrd + Ord, V: IntoMut + Clone> IntoMut for Registry<K, V> {
    fn into_mut(self, scope: &mut crate::dsl::ir::Scope) -> Self {
...
impl<K: PartialOrd + Ord, V> RudaDebug for Registry<K, V> {}
