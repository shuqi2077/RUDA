...
use crate::dsl::frontend::{RudaPrimitive, RudaType, NativeAssign, NativeExpand};
use crate::dsl::ir::{BinaryOperator, Instruction, Scope, Type};
use crate::dsl::{prelude::*};
use ruda_core::ir::{Comparison, ConstantValue, ManagedVariable};
...
mod new {
    ...
    use ruda_kernel_macros::comptime_type;

    use crate::dsl::prelude::Cast;
...
mod bool_and {
    use ruda_core::ir::Operator;

    use crate::dsl::prelude::binary_expand;
...
impl<P: Scalar, N: Size> NativeAssign for Vector<P, N> {
    fn elem_init_mut(scope: &mut crate::dsl::ir::Scope, elem: ManagedVariable) -> ManagedVariable {
