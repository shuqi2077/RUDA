...
use super::{RudaPrimitive, Vector};
...
/// Returns true if the ruda unit has the lowest `plane_unit_id` among active unit in the plane
...
pub fn plane_broadcast<E: RudaPrimitive>(value: E, index: u32) -> E {
    unexpanded!()
}
...
pub mod plane_broadcast {
    ...
    pub fn expand<E: RudaPrimitive>(
        ...
        scope.register(Instruction::new(
            Plane::Broadcast(crate::dsl::ir::BinaryOperator { lhs, rhs }),
            out,
        ));
...
#[allow(unused_variables)]
pub fn plane_shuffle<E: RudaPrimitive>(value: E, src_lane: u32) -> E {
    unexpanded!()
}
...
pub mod plane_shuffle {
    ...
    pub fn expand<E: RudaPrimitive>(
        ...
        scope.register(Instruction::new(
            Plane::Shuffle(crate::dsl::ir::BinaryOperator { lhs, rhs }),
            out,
        ));
...
/// - etc.
#[allow(unused_variables)]
pub fn plane_shuffle_xor<E: RudaPrimitive>(value: E, mask: u32) -> E {
    unexpanded!()
}
...
pub mod plane_shuffle_xor {
    ...
    pub fn expand<E: RudaPrimitive>(
        ...
        scope.register(Instruction::new(
            Plane::ShuffleXor(crate::dsl::ir::BinaryOperator { lhs, rhs }),
            out,
        ));
...
#[allow(unused_variables)]
pub fn plane_shuffle_up<E: RudaPrimitive>(value: E, delta: u32) -> E {
    unexpanded!()
}
...
pub mod plane_shuffle_up {
    ...
    pub fn expand<E: RudaPrimitive>(
        ...
        scope.register(Instruction::new(
            Plane::ShuffleUp(crate::dsl::ir::BinaryOperator { lhs, rhs }),
            out,
        ));
...
#[allow(unused_variables)]
pub fn plane_shuffle_down<E: RudaPrimitive>(value: E, delta: u32) -> E {
    unexpanded!()
}
...
pub mod plane_shuffle_down {
    ...
    pub fn expand<E: RudaPrimitive>(
        ...
        scope.register(Instruction::new(
            Plane::ShuffleDown(crate::dsl::ir::BinaryOperator { lhs, rhs }),
            out,
        ));
...
#[allow(unused_variables)]
pub fn plane_sum<E: RudaPrimitive>(value: E) -> E {
    unexpanded!()
}
...
pub mod plane_sum {
    ...
    pub fn expand<E: RudaPrimitive>(scope: &mut Scope, elem: NativeExpand<E>) -> NativeExpand<E> {
...
#[allow(unused_variables)]
pub fn plane_inclusive_sum<E: RudaPrimitive>(value: E) -> E {
    unexpanded!()
}
...
#[allow(unused_variables)]
pub fn plane_exclusive_sum<E: RudaPrimitive>(value: E) -> E {
    unexpanded!()
}
...
pub fn plane_prod<E: RudaPrimitive>(_elem: E) -> E {
    unexpanded!()
}
...
#[allow(unused_variables)]
pub fn plane_inclusive_prod<E: RudaPrimitive>(value: E) -> E {
    unexpanded!()
}
...
#[allow(unused_variables)]
pub fn plane_exclusive_prod<E: RudaPrimitive>(value: E) -> E {
    unexpanded!()
}
...
pub fn plane_max<E: RudaPrimitive>(_elem: E) -> E {
    unexpanded!()
}
...
pub fn plane_min<E: RudaPrimitive>(_elem: E) -> E {
    unexpanded!()
}
