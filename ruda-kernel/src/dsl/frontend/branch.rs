...
use crate::dsl::{ir::Switch, prelude::RudaEnum};
use crate::dsl::{
    ir::{Branch, If, IfElse, Loop, RangeLoop, Scope},
    prelude::Assign,
};

use super::{RudaType, Int, NativeExpand, Numeric};
...
impl<I: Int> Iterable<I> for RangeExpand<I> {
    fn expand_unroll(
        self,
        scope: &mut Scope,
        mut body: impl FnMut(&mut Scope, <I as RudaType>::ExpandType),
    ) {
        let start = self
            .start
            .expand
...
pub mod range {
    ...
    use crate::dsl::prelude::{Int, NativeExpand};
...
#[allow(clippy::large_enum_variant)]
pub enum MatchExpand<T: RudaEnum> {
    ComptimeVariant {
        variant: i32,
...
pub fn match_expand<T: RudaEnum>(
    scope: &mut Scope,
    value: T,
    discriminant0: i32,
...
#[allow(clippy::large_enum_variant)]
pub enum MatchExpandExpr<T: RudaEnum, C: Assign> {
    ComptimeVariant {
        variant: i32,
        runtime_value: T::RuntimeValue,
        out: Option<C>,
...
impl<T: RudaEnum, C: Assign> MatchExpandExpr<T, C> {
    pub fn case(
        mut self,
        scope: &mut Scope,
        value: i32,
...
pub fn match_expand_expr<T: RudaEnum, C: Assign>(
    scope: &mut Scope,
    value: T,
    discriminant0: i32,
