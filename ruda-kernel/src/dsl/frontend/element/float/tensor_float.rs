...
use super::{RudaPrimitive, RudaType, Float, IntoRuntime, NativeAssign, NativeExpand};
...
impl Float for tf32 {
    ...
    /// Maximum possible [`ruda_core::tf32`] power of 10 exponent
    const MAX_10_EXP: i32 = 38;
    /// Maximum possible [`ruda_core::tf32`] power of 2 exponent
    const MAX_EXP: i32 = 128;

    /// Minimum possible normal [`ruda_core::tf32`] power of 10 exponent
    const MIN_10_EXP: i32 = -37;
    /// One greater than the minimum possible normal [`ruda_core::tf32`] power of 2 exponent
