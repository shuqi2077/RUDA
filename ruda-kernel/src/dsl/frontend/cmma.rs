...
use super::{
    RudaDebug, RudaPrimitive, RudaType, IntoMut, NativeExpand, ReadOnly, Slice, SliceExpand,
    SliceMut,
};
...
use ruda_kernel_macros::{comptime_type, ruda, intrinsic};

use ruda_core::ir::{CoopMma, ManagedVariable, Scope, StorageType, VectorSize};
...
pub struct MatrixExpand<C: RudaType> {
...
impl<C: RudaType> Clone for MatrixExpand<C> {
    fn clone(&self) -> Self {
        Self {
...
impl<C: RudaType> IntoMut for MatrixExpand<C> {
    fn into_mut(self, _scope: &mut Scope) -> Self {
        self
    }
}

impl<C: RudaType> RudaDebug for MatrixExpand<C> {
    fn set_debug_name(&self, scope: &mut Scope, name: &'static str) {
...
impl<A: Scalar, B: Scalar, CD: Scalar> MmaDefinition<A, B, CD> {
    ...
    /// Refer to [nvidia documentation](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#element-types-and-matrix-sizes).
    #[allow(unused_variables)]
    pub fn new_scaled<S: RudaPrimitive>(
        #[comptime] m: usize,
        #[comptime] n: usize,
        #[comptime] k: usize,
    ...
    pub fn vector_size(&self, #[comptime] ident: MatrixIdent) -> comptime_type!(VectorSize) {
        intrinsic!(|scope| {
            ...
            let matrix = ruda_core::ir::Matrix {
                ident,
                m: self.m,
                n: self.n,
                k: self.k,
    ...
    #[allow(unused_variables)]
    pub fn load_matrix<E: RudaPrimitive, NO: Size>(
        &self,
        row: &Slice<E>,
        #[comptime] ident: MatrixIdent,
    ...
    /// Address must be in shared memory
    #[allow(unused_variables)]
    pub fn store_matrix<E: RudaPrimitive, N: Size>(
        &self,
...
#[allow(unused_variables)]
pub fn load<C: RudaPrimitive, V: RudaPrimitive>(mat: &Matrix<C>, value: &Slice<V>, stride: u32) {
    unexpanded!()
}
...
pub mod load {
    ...
    #[allow(unused_variables)]
    pub fn expand<C: RudaPrimitive, V: RudaPrimitive>(
        scope: &mut Scope,
        mat: MatrixExpand<C>,
...
pub mod load_with_layout {
    ...
    #[allow(unused_variables)]
    pub fn expand<C: RudaType, V: RudaPrimitive>(
        scope: &mut Scope,
        mat: MatrixExpand<C>,
        value: SliceExpand<V, ReadOnly>,
        stride: NativeExpand<u32>,
...
#[allow(unused_variables)]
pub fn store<C: RudaPrimitive, O: RudaPrimitive>(
...
pub mod store {
    use crate::dsl::prelude::ReadWrite;

    use super::*;

    /// Expand method of [`store()`].
    #[allow(unused_variables)]
    pub fn expand<C: RudaPrimitive, O: RudaPrimitive>(
        scope: &mut Scope,
...
pub mod execute {
    ...
    pub fn expand<A: RudaPrimitive, B: RudaPrimitive, C: RudaPrimitive, D: RudaPrimitive>(
        scope: &mut Scope,
...
/// Store the matrix in the given array following the given stride and layout.
#[allow(unused_variables)]
pub fn cast<C: RudaPrimitive, O: RudaPrimitive>(input: &Matrix<C>) -> Matrix<O> {
    unexpanded!()
}
...
impl IntoMut for MatrixLayout {
    fn into_mut(self, _scope: &mut crate::dsl::ir::Scope) -> Self {
        self
    }
}

impl RudaDebug for MatrixLayout {}
