...
pub fn test_switch_const<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
...
pub fn test_switch_statement<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
    let handle = client.create_from_slice(as_bytes![F: 0.0, 1.0]);
...
pub fn test_switch_used_as_value<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
    let handle = client.create_from_slice(as_bytes![F: 0.0, 1.0]);
...
pub fn test_switch_default<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
    let handle = client.create_from_slice(as_bytes![F: 0.0, 1.0]);
...
pub fn test_switch_or_branch<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
    let handle = client.create_from_slice(as_bytes![F: 0.0, 1.0]);
...
pub fn test_select<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>, cond: bool) {
...
pub fn test_for_loop_with_break<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
...
macro_rules! testgen_branch {
    () => {
        ...
        fn test_switch_statement() {
            ...
            ruda_kernel::dsl::runtime_tests::branch::test_switch_statement::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_switch_used_as_value() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::branch::test_switch_used_as_value::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_switch_default() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::branch::test_switch_default::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_switch_or_branch() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::branch::test_switch_or_branch::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_select_true() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::branch::test_select::<TestRuntime, FloatType>(client, true);
        }

        #[$crate::dsl::runtime_tests::test_log::test]
        fn test_select_false() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::branch::test_select::<TestRuntime, FloatType>(
                client, false,
            );
        }
        ...
        fn test_switch_const() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::branch::test_switch_const::<TestRuntime, FloatType>(client);
        }

        #[$crate::dsl::runtime_tests::test_log::test]
        fn test_for_loop_with_break() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::branch::test_for_loop_with_break::<TestRuntime, FloatType>(
                client,
            );
        }
    };
