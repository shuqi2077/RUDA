...
pub(crate) fn assert_equals_approx<R: Runtime, F: num_traits::Float + RudaElement + Display>(
...
macro_rules! test_unary_impl {
    ...
    (
        ...
        $epsilon:expr) => {
        pub fn $test_name<R: Runtime, $float_type: Float + num_traits::Float + RudaElement + Display>(client: ComputeClient<R>) {
            #[ruda(launch_unchecked, fast_math = FastMath::all())]
            ...
            $(
            {
                ...
                unsafe {
                    test_function::launch_unchecked::<$float_type, R>(
                        ...
                        RudaDim::new_1d((input.len() / $input_vectorization as usize) as u32),
                        $input_vectorization,
                        $out_vectorization,
...
macro_rules! test_unary_impl_int {
    (
        ...
        pub fn $test_name<R: Runtime, $int_type: Int + RudaElement>(client: ComputeClient<R>) {
            #[ruda(launch_unchecked)]
            ...
            macro_rules! add_test {
                ($test_name:ident) => {
                    ...
                    fn $test_name() {
                        ...
                        ruda_kernel::dsl::runtime_tests::unary::$test_name::<TestRuntime, FloatType>(
                            client,
                        );
                    }
                };
...
pub fn test_vector_sum_int<R: Runtime, I: Int + RudaElement>(client: ComputeClient<R>) {
    #[ruda(launch_unchecked)]
    ...
    // vec1: identity
    {
        ...
        unsafe {
            test_function::launch_unchecked::<I, R>(
                &client,
                RudaCount::Static(1, 1, 1),
                RudaDim::new_1d(input.len() as u32),
                1usize,
                1usize,
                ArrayArg::from_raw_parts(input_handle, input.len()),
        ...
        mod unary_int {
            ...
            macro_rules! add_test {
                ($test_name:ident) => {
                    ...
                    fn $test_name() {
                        let client = TestRuntime::client(&Default::default());
                        ruda_kernel::dsl::runtime_tests::unary::$test_name::<TestRuntime, IntType>(
                            client,
                        );
                    }
                };
