...
pub fn test_vector_index<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
...
pub fn test_vector_index_assign<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
    for vector_size in client.io_optimized_vector_sizes(size_of::<F>()) {
        let handle = client.create_from_slice(F::as_bytes(&vec![F::new(0.0); vector_size]));
        unsafe {
...
pub fn test_vector_loop_unroll<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
    for vector_size in client.io_optimized_vector_sizes(size_of::<F>()) {
        let handle = client.create_from_slice(F::as_bytes(&vec![F::new(0.0); vector_size]));
        unsafe {
...
pub fn test_vector_conditional<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
...
pub fn test_shared_memory<R: Runtime, F: Float + RudaElement>(client: ComputeClient<R>) {
    for vector_size in client.io_optimized_vector_sizes(size_of::<F>()) {
        let output = client.create_from_slice(F::as_bytes(&vec![F::new(0.0); vector_size]));
        unsafe {
...
macro_rules! impl_vector_comparison {
    ($cmp:ident, $expected:expr) => {
        ::paste::paste! {
            ...
            pub fn [< test_vector_ $cmp >] <R: Runtime, F: Float + RudaElement>(
...
macro_rules! testgen_vector {
    () => {
        ...
        fn test_vector_index() {
            ...
            ruda_kernel::dsl::runtime_tests::vector::test_vector_index::<TestRuntime, FloatType>(client);
        }

        #[$crate::dsl::runtime_tests::test_log::test]
        fn test_vector_index_assign() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_index_assign::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_vector_loop_unroll() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_loop_unroll::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_vector_conditional() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_conditional::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_shared_memory() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_shared_memory::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_vector_equal() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_equal::<TestRuntime, FloatType>(client);
        }

        #[$crate::dsl::runtime_tests::test_log::test]
        fn test_vector_not_equal() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_not_equal::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_vector_less_than() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_less_than::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_vector_greater_than() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_greater_than::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_vector_less_equal() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_less_equal::<TestRuntime, FloatType>(
                client,
            );
        }
        ...
        fn test_vector_greater_equal() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::vector::test_vector_greater_equal::<TestRuntime, FloatType>(
                client,
            );
        }
    };
