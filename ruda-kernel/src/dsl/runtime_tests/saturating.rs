...
pub fn test_saturating_add_unsigned<R: Runtime, I: Int + RudaElement>(
    client: ComputeClient<R>,
    vector_size: VectorSize,
) {
    if I::ruda_type() == u64::ruda_type() {
...
#[allow(clippy::needless_range_loop)]
pub fn test_saturating_sub_unsigned<R: Runtime, I: Int + RudaElement>(
    client: ComputeClient<R>,
    vector_size: VectorSize,
) {
    if I::ruda_type() == u64::ruda_type() {
...
#[allow(clippy::needless_range_loop)]
pub fn test_saturating_add_signed<R: Runtime, I: Int + RudaElement>(
    client: ComputeClient<R>,
    vector_size: VectorSize,
) {
    let lhs = vec![
...
// Signed has a lot more possible cases due to overflow/underflow
#[allow(clippy::needless_range_loop)]
pub fn test_saturating_sub_signed<R: Runtime, I: Int + RudaElement>(
    client: ComputeClient<R>,
    vector_size: VectorSize,
) {
    let lhs = vec![
...
macro_rules! testgen_saturating_uint {
    () => {
        ...
        fn test_saturating_add_unsigned() {
            ...
            let test = ruda_kernel::dsl::runtime_tests::saturating::test_saturating_add_unsigned::<
                TestRuntime,
                UintType,
            >;
            test(client.clone(), 1);
        ...
        fn test_saturating_sub_unsigned() {
            let client = TestRuntime::client(&Default::default());
            let test = ruda_kernel::dsl::runtime_tests::saturating::test_saturating_sub_unsigned::<
                TestRuntime,
                UintType,
            >;
            test(client.clone(), 1);
...
macro_rules! testgen_saturating_int {
    () => {
        ...
        fn test_saturating_add_signed() {
            let client = TestRuntime::client(&Default::default());
            let test = ruda_kernel::dsl::runtime_tests::saturating::test_saturating_add_signed::<
                TestRuntime,
                IntType,
            >;
            test(client.clone(), 1);
        ...
        fn test_saturating_sub_signed() {
            let client = TestRuntime::client(&Default::default());
            let test = ruda_kernel::dsl::runtime_tests::saturating::test_saturating_sub_signed::<
                TestRuntime,
                IntType,
            >;
            test(client.clone(), 1);
