...
use ruda_core::ir::{StorageType, features::AtomicUsage};
...
pub fn test_kernel_atomic_add<R: Runtime, F: Numeric + RudaElement>(
    client: ComputeClient<R>,
    vector_size: usize,
) {
    ...
    kernel_atomic_add::launch::<F, R>(
        ...
        RudaDim::new(client.properties(), 1),
        vector_size,
...
pub fn test_kernel_atomic_min<R: Runtime, F: Numeric + RudaElement>(
    client: ComputeClient<R>,
    vector_size: usize,
) {
...
pub fn test_kernel_atomic_max<R: Runtime, F: Numeric + RudaElement>(
    client: ComputeClient<R>,
    vector_size: usize,
) {
    if !supports_feature::<R, F>(&client, AtomicUsage::MinMax, vector_size) {
...
macro_rules! testgen_atomic_untyped {
    () => {
        ...
        fn test_regression_issue_1218() {
            ...
            ruda_kernel::dsl::runtime_tests::atomic::test_regression_issue_1218::<TestRuntime>(client);
        }
    };
}
...
macro_rules! testgen_atomic_int {
    () => {
        ...
        fn test_atomic_add_int() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::atomic::test_kernel_atomic_add::<TestRuntime, IntType>(
                client, 1,
            );
        }
        ...
        fn test_atomic_min_int() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::atomic::test_kernel_atomic_min::<TestRuntime, IntType>(
                client, 1,
            );
        }
        ...
        fn test_atomic_max_int() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::atomic::test_kernel_atomic_max::<TestRuntime, IntType>(
                client, 1,
            );
        }
    };
...
macro_rules! testgen_atomic_float {
    () => {
        ...
        fn test_atomic_add_float() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::atomic::test_kernel_atomic_add::<TestRuntime, FloatType>(
                client, 1,
            );
        }
        ...
        fn test_atomic_min_float() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::atomic::test_kernel_atomic_min::<TestRuntime, FloatType>(
                client, 1,
            );
        }
        ...
        fn test_atomic_max_float() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::atomic::test_kernel_atomic_max::<TestRuntime, FloatType>(
                client, 1,
            );
        }
