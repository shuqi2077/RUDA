...
use crate::dsl::{as_type, stub::Lazy};
...
macro_rules! test_binary_impl {
    (
        ...
        pub fn $test_name<R: Runtime, $float_type: Float + num_traits::Float + RudaElement + Display>(client: ComputeClient<R>) {
            #[ruda(launch_unchecked, fast_math = *FAST_MATH)]
            ...
            $(
            {
                ...
                unsafe {
                    test_function::launch_unchecked::<$float_type, R>(
                        ...
                        RudaDim::new_1d((lhs.len() / $input_vectorization as usize) as u32),
                        $input_vectorization,
                        $out_vectorization,
            ...
            macro_rules! add_test {
                ($test_name:ident) => {
                    ...
                    fn $test_name() {
                        ...
                        ruda_kernel::dsl::runtime_tests::binary::$test_name::<TestRuntime, FloatType>(
                            client,
                        );
                    }
                };
        ...
        mod binary_untyped {
            ...
            macro_rules! add_test {
                ($test_name:ident) => {
                    ...
                    fn $test_name() {
                        let client = TestRuntime::client(&Default::default());
                        ruda_kernel::dsl::runtime_tests::binary::$test_name::<TestRuntime>(client);
                    }
                };
                ($test_name:ident, $ty:ty) => {
                    ...
                    fn $test_name() {
                        let client = TestRuntime::client(&Default::default());
                        ruda_kernel::dsl::runtime_tests::binary::$test_name::<TestRuntime, $ty>(client);
                    }
                };
            }
