use crate::dsl::runtime_tests::binary::assert_equals_approx;
...
pub fn test_plane_sum<
    TestRuntime: Runtime,
    F: Float + num_traits::Float + RudaElement + Display,
>(
...
>(
    ...
    Launch: Fn(RudaCount, TensorArg<TestRuntime>),
{
    if !client.features().plane.contains(Plane::Ops) {
        // Can't execute the test.
        return;
...
macro_rules! testgen_plane {
    () => {
        ...
        fn impl_test_plane_sum(vectorization: VectorSize) {
            ...
            ruda_kernel::dsl::runtime_tests::plane::test_plane_sum::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_inclusive_sum(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_inclusive_sum::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_exclusive_sum(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_exclusive_sum::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_prod(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_prod::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_inclusive_prod(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_inclusive_prod::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_exclusive_prod(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_exclusive_prod::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_max(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_max::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_min(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_min::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn test_plane_all() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_all::<TestRuntime, FloatType>(
                client.clone(),
            );
        }
        ...
        fn test_plane_any() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_any::<TestRuntime, FloatType>(
                client.clone(),
            );
        }
        ...
        fn impl_test_plane_elect(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_elect::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_broadcast(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_broadcast::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn test_plane_ballot() {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_ballot::<TestRuntime>(client.clone());
        }

        fn impl_test_plane_shuffle(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_shuffle::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_shuffle_xor(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_shuffle_xor::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_shuffle_up(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_shuffle_up::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
        ...
        fn impl_test_plane_shuffle_down(vectorization: VectorSize) {
            let client = TestRuntime::client(&Default::default());
            ruda_kernel::dsl::runtime_tests::plane::test_plane_shuffle_down::<TestRuntime, FloatType>(
                client.clone(),
                vectorization,
            );
        }
