...
use ruda_core::ir::{ManagedVariable, Variable};
...
#[ruda]
pub fn read_masked<C: RudaPrimitive>(mask: bool, list: Slice<C>, index: usize, value: C) -> C {
...
#[ruda]
pub fn read_tensor_checked<C: RudaPrimitive + Default + IntoRuntime>(
    tensor: Tensor<C>,
    index: usize,
...
/// Returns the value at `index` in tensor within bounds.
#[ruda]
pub fn read_tensor_validate<C: RudaPrimitive + Default + IntoRuntime>(
    tensor: Tensor<C>,
    index: usize,
    #[comptime] unroll_factor: usize,
...
#[ruda]
#[allow(unused)]
fn print_oob<Out: RudaType<ExpandType: Into<Variable>>>(
    #[comptime] kernel_name: String,
