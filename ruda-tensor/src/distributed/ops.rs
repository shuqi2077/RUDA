...
// TODO : The following functions should be moved in the `ruda-autodiff` crate. The difficulty is in not discriminating between
...
pub trait DistributedBackend: Backend {
    ...
    /// # Safety
    ///
    /// Ensure collective execution has been synchronized before computing with
    /// the returned handle, or keep it wrapped as an unresolved collective.
