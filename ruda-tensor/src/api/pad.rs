...
use crate::api::{Element, ElementConversion, Tensor, backend::Backend, ops::PadMode};
    ...
    K::Elem: Element,
{
    ...
    /// use ruda_tensor::api::ops::PadMode;
    ///
    ...
    E: ElementConversion,
{
    ...
    let padded_tensor = Tensor::full(padded_dims, value, (&tensor.device(), tensor.dtype()));
    ...
    K::Elem: Element,
{
    ...
    let output = Tensor::zeros(output_dims, (&tensor.device(), tensor.dtype()));
