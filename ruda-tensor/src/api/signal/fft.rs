...
///     let (real, imag) = ruda_tensor::api::signal::rfft(signal, 0, None);
/// }
/// ```
...
///     let signal = ruda_tensor::api::signal::irfft(real, imag, 0, None);
/// }
/// ```
...
///     let (spec_re, spec_im) = ruda_tensor::api::signal::cfft(re, im, 0, None);
/// }
/// ```
