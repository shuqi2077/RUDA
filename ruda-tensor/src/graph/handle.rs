...
impl<H: Clone> HandleContainer<H> {
    ...
    /// Get the [float tensor](crate::backend::BackendTypes::FloatTensorPrimitive) corresponding to the
    ...
    /// Get the [int tensor](crate::backend::BackendTypes::IntTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [bool tensor](crate::backend::BackendTypes::BoolTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [quantized tensor](crate::backend::BackendTypes::QuantizedTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Register a new [float tensor](crate::backend::BackendTypes::FloatTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [quantized tensor](crate::backend::BackendTypes::QuantizedTensorPrimitive) with the corresponding [tensor ids](TensorId).
    ...
    /// Register a new [int tensor](crate::backend::BackendTypes::IntTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [bool tensor](crate::backend::BackendTypes::BoolTensorPrimitive) with the corresponding [tensor id](TensorId).
