...
pub trait ConfigAnalyzer {
    ...
    fn gen_serde_impl(&self, _paths: &crate::DerivePaths) -> TokenStream;
    fn gen_clone_impl(&self) -> TokenStream;
    fn gen_display_impl(&self, _paths: &crate::DerivePaths) -> TokenStream;
    fn gen_config_impl(&self, _paths: &crate::DerivePaths) -> TokenStream;
}
