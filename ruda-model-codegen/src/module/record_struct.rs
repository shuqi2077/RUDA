...
impl ModuleRecordCodegen for StructModuleRecordCodegen {
    fn gen_record_type(&self, record_name: &Ident, generics: &Generics, paths: &crate::DerivePaths) -> (TokenStream, Generics) {
        ...
        for field in self.fields.iter() {
            ...
            if field.field_type.is_persistent_module() || field.field_type.maybe_generic_module() {
                fields.extend(quote! {
                    ...
                    #vis #name: <#ty as #model::module::Module<B>>::Record,
                });
                ...
                match field.field_type.attr {
                    ...
                    None | Some(ModuleFieldAttribute::Skip) => {
                        fields.extend(quote! {
                            #[allow(missing_docs)]
                            #vis #name: #model::module::EmptyRecord,
                        });
