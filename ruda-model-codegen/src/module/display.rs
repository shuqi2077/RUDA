...
pub fn attributes_fn(ast: &syn::DeriveInput, paths: &crate::DerivePaths) -> proc_macro2::TokenStream {
...
pub fn display_fn(_ast: &syn::DeriveInput, paths: &crate::DerivePaths) -> proc_macro2::TokenStream {
    let model = &paths.model;
    quote! {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            let formatted = #model::module::ModuleDisplay::format(self, Default::default());
            write!(f, "{}", formatted)
        }
    }
}
