...
use crate::{FuserStatus, OperationFuser};
use ruda_tensor::graph::{NumericOperationIr, OperationIr, ReduceDimOpIr};
...
impl<R: Runtime> OperationFuser<RudaOptimization<R>> for ReduceFuser<R> {
