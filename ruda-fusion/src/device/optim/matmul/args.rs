use crate::device::engine::codegen::{
    io::ref_vector_size,
...
impl MatmulArgs for FusedMatmulArgs {
    type Output<EO: RudaPrimitive> = GlobalArgs;
    type Input<Lhs: RudaPrimitive, Rhs: RudaPrimitive, EO: RudaPrimitive> = FusedMatmulInput;
    type State<Lhs: RudaPrimitive, Rhs: RudaPrimitive, EO: RudaPrimitive> = FusedMatmulState;
    type Config = ();
...
fn global_view<E: RudaPrimitive>(
    inputs: &GlobalArgs,
    locals: &LocalArgs,
