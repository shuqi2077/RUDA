...
use crate::device::optim::reduce::tune::fused_reduce_autotune;
use crate::device::{
...
use ruprim::reduce::launch::RoutineStrategy;
...
impl<R: Runtime> ReduceBroadcastedOptimizationTuneArg<R> {
    ...
    pub fn execute_fallback(&self, context: &mut Context<RudaFusionHandle<R>>) {
