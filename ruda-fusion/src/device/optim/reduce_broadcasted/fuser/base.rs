...
impl<R: Runtime> OperationFuser<RudaOptimization<R>> for ReduceBroadcastedFuser<R> {
    ...
    fn finish(&mut self) -> RudaOptimization<R> {
        ...
        RudaOptimization::ReduceBroadcasted(ReduceBroadcastedOptimization { info, num_ops })
    }
...
mod tests {
    ...
    type Run = ruda_test_runtime::TestRuntime;
    ...
    fn reduce_broadcast_workflow_1() {
        ...
        fuser.fuse(&OperationIr::NumericFloat(
            DType::F32,
            ruda_tensor::graph::NumericOperationIr::SumDim(ReduceDimOpIr {
                input: tensor1,
                out: tensor2_out,
                axis: 1,
                accumulator_len: 1,
        ...
        fuser.fuse(&OperationIr::NumericFloat(
            DType::F32,
            ruda_tensor::graph::NumericOperationIr::Add(BinaryOpIr {
                lhs: tensor2,
                rhs: tensor3,
                out: tensor4_out,
            }),
