...
impl<B: FusionBackend> ModuleOps<Fusion<B>> for Fusion<B> {
    ...
    fn attention(
        ...
        mask: Option<ruda_tensor::tensor::BoolTensor<Fusion<B>>>,
        attn_bias: Option<FloatTensor<Fusion<B>>>,
        options: ruda_tensor::ops::AttentionModuleOptions,
    ) -> FloatTensor<Fusion<B>> {
        make_ops!(
            AttentionOps,
            AttentionOpIr,
    ...
    fn ctc_loss(
        ...
        // either runs a native kernel (ruda, libtorch) or the decomposed
