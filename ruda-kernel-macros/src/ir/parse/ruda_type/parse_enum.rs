...
use crate::ir::paths::prelude_type;

#[derive(Debug)]
pub struct RudaTypeEnum {
    pub ident: Ident,
    pub name_expand: Ident,
    pub variants: Vec<RudaTypeVariant>,
...
#[darling(attributes(ruda, launch), supports(enum_any))]
pub struct RudaTypeEnumRepr {
    ident: Ident,
    vis: syn::Visibility,
...
impl FromDeriveInput for RudaTypeEnum {
    fn from_derive_input(input: &syn::DeriveInput) -> darling::Result<Self> {
        let repr = RudaTypeEnumRepr::from_derive_input(input)?;
