...
use ruda_core::tensor::{BoolDType, FloatDType, IntDType, Shape};
...
impl<B: Backend, C: CheckpointStrategy> BoolTensorOps<Self> for Autodiff<B, C> {
    ...
    fn bool_slice(tensor: BoolTensor<B>, slices: &[ruda_core::tensor::Slice]) -> BoolTensor<B> {
    ...
    async fn bool_argwhere(tensor: BoolTensor<B>, out_dtype: ruda_core::tensor::IntDType) -> IntTensor<B> {
