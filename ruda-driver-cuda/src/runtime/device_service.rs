...
impl DeviceService for CudaServer {
    fn init(device_id: ruda_core::device::DeviceId) -> Self {
        ...
        let hardware_props = unsafe {
            ...
            let max_ruda_dim = (block_dim_x as u32, block_dim_y as u32, block_dim_z as u32);
            ...
            let max_ruda_count = (grid_dim_x as u32, grid_dim_y as u32, grid_dim_z as u32);
            ...
            HardwareProperties {
                ...
                max_ruda_count,
                max_units_per_ruda: max_threads,
                max_ruda_dim,
        ...
        if arch_version >= 70 {
            ...
            device_props
                .register_type_usage(OpaqueType::Barrier(BarrierLevel::Ruda), TypeUsage::Buffer);
        ...
        if arch_version >= 90 {
            ...
            device_props.features.ruda_cluster = true;
