...
pub(crate) type WmmaCompiler = ruda_compiler::cpp::cuda::mma::PtxWmmaCompiler;

#[cfg(not(feature = "ptx-wmma"))]
pub(crate) type WmmaCompiler = ruda_compiler::cpp::cuda::mma::CudaWmmaCompiler;
...
mod tests {
    ...
    ruda_kernel::dsl::testgen_all!(f32: [f16, bf16, f32, f64], i32: [i8, i16, i32, i64], u32: [u8, u16, u32, u64]);
