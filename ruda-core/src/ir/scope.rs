...
use crate::ir::{
    BarrierLevel, RudaFnSource, DeviceProperties, FastMath, ManagedVariable, Matrix, Processor,
...
/// The scope is the main [`crate::ir::Operation`] and [`crate::ir::Variable`] container that simplify
...
pub struct Scope {
    ...
    pub debug: DebugInfo,
    #[type_hash(skip)]
    #[cfg_attr(feature = "ir-serde", serde(skip))]
    pub typemap: TypeMap,
    #[type_hash(skip)]
    #[cfg_attr(feature = "ir-serde", serde(skip))]
    pub sizemap: SizeMap,
...
pub struct DebugInfo {
    pub enabled: bool,
    pub sources: Rc<RefCell<HashSet<RudaFnSource>>>,
...
impl Scope {
    ...
    pub fn input(&mut self, id: Id, item: Type) -> ManagedVariable {
        ManagedVariable::Plain(crate::ir::Variable::new(
    ...
    pub fn update_source(&mut self, source: RudaFnSource) {
