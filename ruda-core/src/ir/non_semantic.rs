...
use crate::ir::TypeHash;

use crate::ir::{OperationCode, OperationReflect, fmt_vararg};
...
pub enum NonSemantic {
    /// Enter a new debug scope, this happens recursively when a ruda function is called and
...
pub struct SourceLoc {
    pub line: u32,
    pub column: u32,
    pub source: RudaFnSource,
}

/// A ruda function's source
#[cfg_attr(feature = "ir-serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Debug, Clone, PartialEq, Eq, Hash, TypeHash)]
pub struct RudaFnSource {
