...
//!
//! ```
//! use ruda_core::bytes::{Bytes, AllocationProperty};
//!
...
impl SharedBytesAllocationController {
    ...
    ///
    /// ```
    /// use ruda_core::bytes::{SharedBytesAllocationController, AllocationProperty};
    ///
...
mod tests {
    ...
    fn test_slices_from_static_region() {
        ...
        // Create ruda Bytes from each slice (zero-copy)
