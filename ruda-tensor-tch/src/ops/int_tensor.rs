...
impl<E: TchElement> IntTensorOps<Self> for LibTorch<E> {
    fn int_from_data(data: TensorData, device: &LibTorchDevice) -> TchTensor {
        match data.dtype {
            ruda_tensor::DType::I64 => TchTensor::from_data::<i64>(data, (*device).into()),
            ruda_tensor::DType::I32 => TchTensor::from_data::<i32>(data, (*device).into()),
            ruda_tensor::DType::I16 => TchTensor::from_data::<i16>(data, (*device).into()),
            ruda_tensor::DType::I8 => TchTensor::from_data::<i8>(data, (*device).into()),
            ruda_tensor::DType::U8 => TchTensor::from_data::<u8>(data, (*device).into()),
    ...
    fn int_slice(tensor: TchTensor, slices: &[ruda_tensor::Slice]) -> TchTensor {
