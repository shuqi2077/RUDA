...
pub enum AutoCompiler {
    Wgsl(WgslCompiler),
    #[cfg(feature = "spirv")]
    SpirV(ruda_compiler::spirv::SpirvCompiler),
    #[cfg(feature = "msl")]
    Msl(ruda_kernel::dsl::lowering::cpp::MslCompiler),
}
...
pub enum AutoRepresentation {
    ...
    #[cfg(feature = "spirv")]
    SpirV(ruda_compiler::spirv::SpirvKernel),
    #[cfg(feature = "msl")]
...
pub enum AutoRepresentationRef<'a> {
    ...
    #[cfg(feature = "spirv")]
    SpirV(&'a ruda_compiler::spirv::SpirvKernel),
    #[cfg(feature = "msl")]
...
impl AutoRepresentation {
    pub fn as_spirv(&self) -> Option<&ruda_compiler::spirv::SpirvKernel> {
        match self {
...
impl Compiler for AutoCompiler {
    ...
    fn compile(
        ...
        let kernel = match self {
            ...
            AutoCompiler::Msl(msl_compiler) => {
                ...
                let compilation_options = ruda_compiler::cpp::shared::CompilationOptions::default();
    ...
    fn elem_size(&self, elem: ruda_kernel::dsl::ir::ElemType) -> usize {
        match self {
