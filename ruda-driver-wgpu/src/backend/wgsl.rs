use ruda_kernel::dsl::{Compiler, prelude::Visibility, server::KernelArguments};
use ruda_kernel::dsl::{
    WgpuCompilationOptions,
    ir::{ElemType, UIntKind},
};
use ruda_core::ir::{DeviceProperties, Type};
use wgpu::Features;
...
pub fn register_wgsl_features(
    ...
    props: &mut ruda_core::ir::DeviceProperties,
...
pub fn register_types(props: &mut DeviceProperties, adapter: &wgpu::Adapter) {
    use ruda_kernel::dsl::ir::{AddressType, ElemType, FloatKind, IntKind, StorageType};
    use ruda_core::ir::features::*;
