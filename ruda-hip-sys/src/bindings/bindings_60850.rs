...
pub const HIP_VERSION_MINOR: u32 = 14;
pub const HIP_VERSION_PATCH: u32 = 60850;
pub const HIP_VERSION_GITHASH: &[u8; 8] = b"0000000\0";
pub const HIP_VERSION_BUILD_ID: u32 = 0;
pub const HIP_VERSION_BUILD_NAME: &[u8; 1] = b"\0";
pub const HIP_VERSION: u32 = 71460850;
...
pub const hipTextureTypeRudamap: u32 = 12;
pub const hipTextureType1DLayered: u32 = 241;
pub const hipTextureType2DLayered: u32 = 242;
pub const hipTextureTypeRudamapLayered: u32 = 252;
...
pub const HIP_RESOURCE_ABI_BYTES: u32 = 40;
...
pub const hipArrayRudamap: u32 = 4;
...
pub const HIP_EXT_DYN_DATA_PREFETCH_MAX_REGIONS: u32 = 2;
...
pub struct hipDeviceProp_tR0600 {
    ...
    #[doc = "< Maximum rudamap texture dims"]
    pub maxTextureRudamap: ::std::os::raw::c_int,
    ...
    #[doc = "< Maximum rudamaps layered texture dims"]
    pub maxTextureRudamapLayered: [::std::os::raw::c_int; 2usize],
    ...
    #[doc = "< Maximum rudamap surface size"]
    pub maxSurfaceRudamap: ::std::os::raw::c_int,
    #[doc = "< Maximum rudamap layered surface size"]
    pub maxSurfaceRudamapLayered: [::std::os::raw::c_int; 2usize],
...
#[doc = "< Resource type is not valid for the operation."]
pub const hipError_t_hipErrorInvalidResourceType: hipError_t = 914;
#[doc = "< Resource configuration is not valid for\n< the operation."]
pub const hipError_t_hipErrorInvalidResourceConfiguration: hipError_t = 915;
#[doc = "< The stream is detached."]
pub const hipError_t_hipErrorStreamDetached: hipError_t = 916;
#[doc = "< Unknown error."]
...
#[doc = "< Cuda only. Maximum dimensions of Rudamap surface."]
pub const hipDeviceAttribute_t_hipDeviceAttributeMaxSurfaceRudamap: hipDeviceAttribute_t = 37;
#[doc = "< Cuda only. Maximum dimension of Rudamap layered\n< surface."]
pub const hipDeviceAttribute_t_hipDeviceAttributeMaxSurfaceRudamapLayered: hipDeviceAttribute_t =
    38;
...
#[doc = "< Maximum dimensions of Rudamap texture"]
pub const hipDeviceAttribute_t_hipDeviceAttributeMaxTextureRudamap: hipDeviceAttribute_t = 53;
#[doc = "< Maximum dimensions of Rudamap layered texture."]
pub const hipDeviceAttribute_t_hipDeviceAttributeMaxTextureRudamapLayered: hipDeviceAttribute_t =
    54;
...
pub const hipDeviceAttribute_t_hipDeviceAttributeHandleTypeFabricSupported: hipDeviceAttribute_t =
    95;
...
#[doc = "< Maximum number of dynamic data prefetch regions\n< per kernel launch (0 if unsupported)."]
pub const hipDeviceAttribute_t_hipDeviceAttributeMaxDynDataPrefetchRegions: hipDeviceAttribute_t =
    10022;
...
#[doc = "< The src pointer holds the address of the real\n< source pointer, read when the copy runs rather\n< than when it is submitted."]
pub const hipMemcpyFlags_hipMemcpyFlagExtOpIndirectSrc: hipMemcpyFlags = 1024;
#[doc = "< Same as IndirectSrc, but for the dst pointer."]
pub const hipMemcpyFlags_hipMemcpyFlagExtOpIndirectDst: hipMemcpyFlags = 2048;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ihipExecutionCtx_t {
    _unused: [u8; 0],
}
pub type hipExecutionCtx_t = *mut ihipExecutionCtx_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ihipDevResourceDesc_t {
    _unused: [u8; 0],
}
pub type hipDevResourceDesc_t = *mut ihipDevResourceDesc_t;
pub const hipDevResourceType_hipDevResourceTypeInvalid: hipDevResourceType = 0;
pub const hipDevResourceType_hipDevResourceTypeSm: hipDevResourceType = 1;
pub const hipDevResourceType_hipDevResourceTypeWorkqueueConfig: hipDevResourceType = 1000;
pub const hipDevResourceType_hipDevResourceTypeWorkqueue: hipDevResourceType = 10000;
pub type hipDevResourceType = ::std::os::raw::c_uint;
pub const hipDevSmResourceGroup_flags_hipDevSmResourceGroupDefault: hipDevSmResourceGroup_flags = 0;
pub const hipDevSmResourceGroup_flags_hipDevSmResourceGroupBackfill: hipDevSmResourceGroup_flags =
    1;
pub type hipDevSmResourceGroup_flags = ::std::os::raw::c_uint;
pub const hipDevSmResourceSplitByCount_flags_hipDevSmResourceSplitIgnoreSmCoscheduling:
    hipDevSmResourceSplitByCount_flags = 1;
pub const hipDevSmResourceSplitByCount_flags_hipDevSmResourceSplitMaxPotentialClusterSize:
    hipDevSmResourceSplitByCount_flags = 2;
pub type hipDevSmResourceSplitByCount_flags = ::std::os::raw::c_uint;
pub const hipDevWorkqueueConfigScope_hipDevWorkqueueConfigScopeDeviceCtx:
    hipDevWorkqueueConfigScope = 0;
pub const hipDevWorkqueueConfigScope_hipDevWorkqueueConfigScopeGreenCtxBalanced:
    hipDevWorkqueueConfigScope = 1;
pub type hipDevWorkqueueConfigScope = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct hipDevWorkqueueConfigResource {
    ...
    pub sharingScope: hipDevWorkqueueConfigScope,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union hipDevResource_st__bindgen_ty_1 {
    pub sm: hipDevSmResource,
    pub wqConfig: hipDevWorkqueueConfigResource,
    pub wq: hipDevWorkqueueResource,
    pub _oversize: [::std::os::raw::c_uchar; 40usize],
}
pub type hipDevResource = hipDevResource_st;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct hipDevSmResourceGroupParams_st {
    pub smCount: ::std::os::raw::c_uint,
...
pub type hipDevSmResourceGroupParams = hipDevSmResourceGroupParams_st;
...
pub const hipMemAllocationHandleType_hipMemHandleTypeFabric: hipMemAllocationHandleType = 8;
...
#[doc = "< Regular temporal locality"]
pub const hipExtDynDataPrefetchTemporal_hipExtDynDataPrefetchTemporalRegular:
    hipExtDynDataPrefetchTemporal = 0;
#[doc = "< High temporal locality (prefer caching)"]
pub const hipExtDynDataPrefetchTemporal_hipExtDynDataPrefetchTemporalHigh:
    hipExtDynDataPrefetchTemporal = 1;
#[doc = " @brief Temporal locality hint for dynamic data prefetch."]
pub type hipExtDynDataPrefetchTemporal = ::std::os::raw::c_uint;
#[doc = " @brief Describes one 2D memory region to prefetch into L2 cache.\n\n @p address must be aligned to the device's L2 cache line size.\n @p width is measured in bytes and must be a multiple of the cache line size.\n @p height is the number of rows to prefetch.\n @p stride is the byte stride between the start of consecutive rows."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct hipExtDynDataPrefetchRegion {
    #[doc = "< Base address (must be cache-line aligned)"]
    pub address: *mut ::std::os::raw::c_void,
    #[doc = "< Stride between row starts in bytes"]
    pub stride: usize,
    #[doc = "< Width of each row in bytes (must be a multiple of cache line size)"]
    pub width: usize,
    #[doc = "< Number of rows to prefetch"]
    pub height: usize,
}
#[doc = " @brief Configuration for dynamic data prefetch.\n\n Pointed to by a launch attribute via @ref hipLaunchAttributeExtDynDataPrefetch.\n @p numRegions must not exceed the device limit queried via\n @ref hipDeviceAttributeMaxDynDataPrefetchRegions (use @ref hipDeviceGetAttribute).\n\n Cooperative prefetch is always enabled internally; the user only controls\n the temporal policy."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct hipExtDynDataPrefetchConfig {
    #[doc = "< Number of valid regions (1-max)"]
    pub numRegions: ::std::os::raw::c_uint,
    #[doc = "< Cache retention policy for prefetched data"]
    pub temporal: hipExtDynDataPrefetchTemporal,
    #[doc = "< Prefetch regions"]
    pub regions: [hipExtDynDataPrefetchRegion; 2usize],
}
#[doc = "< Ignored entry"]
...
#[doc = "< Valid for launches. Prefetch data into L2 before kernel execution."]
pub const hipLaunchAttributeID_hipLaunchAttributeExtDynDataPrefetch: hipLaunchAttributeID = 1024;
pub const hipLaunchAttributeID_hipLaunchAttributeMax: hipLaunchAttributeID = 1025;
...
pub union hipLaunchAttributeValue {
    ...
    #[doc = "< Value of launch attribute ::hipLaunchAttributeExtDynDataPrefetch"]
    pub dynDataPrefetch: *const hipExtDynDataPrefetchConfig,
}
...
extern "C" {
    #[doc = " @brief Discards and prefetches a batch of memory ranges asynchronously (driver API variant).\n\n @param [in] dptrs              pointers to the memory ranges\n @param [in] sizes              sizes in bytes of the memory ranges\n @param [in] count              number of memory ranges\n @param [in] prefetchLocs       array of target locations for prefetching\n @param [in] prefetchLocIdxs    indices mapping each range to a prefetch location\n @param [in] numPrefetchLocs    number of unique prefetch locations\n @param [in] flags              flags for future use, must be zero now.\n @param [in] stream             stream to enqueue the operation\n\n @returns #hipSuccess, #hipErrorInvalidValue, #hipErrorNotSupported\n\n @note This is the driver API variant that uses hipDeviceptr_t instead of void*.\n\n @see hipMemDiscardAndPrefetchBatchAsync, hipMemDiscardBatchAsync, hipMemPrefetchBatchAsync"]
...
extern "C" {
    ...
    pub fn hipDeviceGetDevResource(
        device: hipDevice_t,
...
extern "C" {
    pub fn hipDevSmResourceSplitByCount(
...
extern "C" {
    pub fn hipDevSmResourceSplit(
        result: *mut hipDevResource,
        nbGroups: ::std::os::raw::c_uint,
        input: *const hipDevResource,
        remainder: *mut hipDevResource,
        flags: ::std::os::raw::c_uint,
        groupParams: *mut hipDevSmResourceGroupParams,
    ) -> hipError_t;
}
extern "C" {
    pub fn hipDevResourceGenerateDesc(
        phDesc: *mut hipDevResourceDesc_t,
        resources: *mut hipDevResource,
        nbResources: ::std::os::raw::c_uint,
    ) -> hipError_t;
}
extern "C" {
    pub fn hipGreenCtxCreate(
...
extern "C" {
    pub fn hipExecutionCtxDestroy(ctx: hipExecutionCtx_t) -> hipError_t;
}
extern "C" {
    pub fn hipDeviceGetExecutionCtx(
        ctx: *mut hipExecutionCtx_t,
        device: ::std::os::raw::c_int,
    ) -> hipError_t;
}
extern "C" {
    pub fn hipExecutionCtxStreamCreate(
        stream: *mut hipStream_t,
...
extern "C" {
    pub fn hipExecutionCtxGetDevResource(
...
extern "C" {
    pub fn hipExecutionCtxGetDevice(
        device: *mut ::std::os::raw::c_int,
        ctx: hipExecutionCtx_t,
    ) -> hipError_t;
}
extern "C" {
    pub fn hipExecutionCtxGetId(
        ctx: hipExecutionCtx_t,
        ctxId: *mut ::std::os::raw::c_ulonglong,
    ) -> hipError_t;
}
extern "C" {
    pub fn hipStreamGetDevResource(
        hStream: hipStream_t,
        resource: *mut hipDevResource,
        type_: hipDevResourceType,
    ) -> hipError_t;
...
extern "C" {
    pub fn hipExecutionCtxRecordEvent(ctx: hipExecutionCtx_t, event: hipEvent_t) -> hipError_t;
}
extern "C" {
    pub fn hipExecutionCtxSynchronize(ctx: hipExecutionCtx_t) -> hipError_t;
}
extern "C" {
    pub fn hipExecutionCtxWaitEvent(ctx: hipExecutionCtx_t, event: hipEvent_t) -> hipError_t;
}
extern "C" {
