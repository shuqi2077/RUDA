...
use ruda_model::module::{Content, DisplaySettings, Initializer, Module, ModuleDisplay, Param};
...
impl<B: Backend> PRelu<B> {
    ...
    /// - output: `[..., any]`
    ///
    /// See also [prelu](ruda_tensor::api::activation::prelu) for more information.
    pub fn forward<const D: usize>(&self, input: Tensor<B, D>) -> Tensor<B, D> {
        ruda_model::tensor::activation::prelu(input, self.alpha.val())
    }
}
