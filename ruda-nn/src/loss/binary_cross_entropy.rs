...
use ruda_model::tensor::activation::log_sigmoid;
use ruda_model::tensor::{FloatDType, Int, Tensor, backend::Backend};
...
impl<B: Backend> BinaryCrossEntropyLoss<B> {
    ...
    pub fn forward<const D: usize>(
        ...
        let mut targets_float = targets.clone().cast(FloatDType::from(dtype));
        ...
        let mut loss = if self.logits {
            ...
            // https://github.com/shuqi2077/RUDA/blob/main/THIRD_PARTY_NOTICES.md: clamp at -100.0 to avoid undefined values
...
mod tests {
    ...
    use ruda_model::tensor::{TensorData, activation::sigmoid};
