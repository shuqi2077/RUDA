...
use ruda_model::tensor::activation::{quiet_softmax, softmax};
#[cfg(not(feature = "std"))]
...
mod tests {
    ...
    use ruda_model::tensor::{Distribution, Shape};
    ...
    #[test]
    fn test_autoregressive_decoding_f32_seed_zero() {
        TestBackend::seed(&Default::default(), 0);
        test_autoregressive_mask_should_have_same_output_as_autoregressive_decoding();
    }
