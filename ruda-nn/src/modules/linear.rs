...
use ruda_model::tensor::module::linear;
...
mod tests {
    ...
    use ruda_model::record::{BinBytesRecorder, FullPrecisionSettings, Recorder};
    use ruda_model::tensor::ElementConversion;
    use ruda_model::tensor::{Shape, TensorData};
    ...
    fn col_row_same_result() {
        ...
        let signal = Tensor::<_, 2>::random([8, 6], ruda_model::tensor::Distribution::Default, &device);
