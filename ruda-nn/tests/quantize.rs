...
use ruda_model::module::{Module, Quantizer};
...
pub type B = ruda_tensor_host::Host;

#[cfg(all(test, feature = "test-wgpu"))]
/// Backend for test cases
pub type B = ruda_tensor_wgpu::Wgpu;

#[cfg(all(test, feature = "test-cuda"))]
/// Backend for test cases
pub type B = ruda_tensor_device::cuda::Cuda;

#[cfg(all(test, feature = "test-rocm"))]
/// Backend for test cases
pub type B = ruda_tensor_rocm::Rocm;
