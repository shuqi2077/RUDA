use ruda_core::kernel::{KernelArg, Visibility};
use rspirv::{
    dr::Operand,
    spirv::{
...
use crate::spirv::{SpirvCompiler, extensions::TargetExtensions, item::Item};
...
impl SpirvTarget for GLCompute {
    fn set_modes(
        ...
        b.execution_mode(main, spirv::ExecutionMode::LocalSize, ruda_dims);
    }
