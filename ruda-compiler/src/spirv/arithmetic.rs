...
use ruda_core::ir::{self as core, Arithmetic, InstructionModes};
...
impl<T: SpirvTarget> SpirvCompiler<T> {
    pub fn compile_arithmetic(
        ...
        match op {
            ...
            Arithmetic::Powi(op) if matches!(op.lhs.elem_type(), core::ElemType::Float(_)) => {
                unreachable!("Floating integer power must be expanded by the lowering transformer");
            }
