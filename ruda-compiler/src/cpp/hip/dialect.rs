...
use crate::cpp::shared::DialectWarpReduceCompiler;
use crate::cpp::{
    Dialect,
    shared::{
        self, DialectBindings, DialectRudaBuiltins, DialectIncludes, DialectTypes,
        DialectWmmaCompiler, Flags, Item, KernelArg, ManualMma,
    },
};
use crate::cpp::{
    shared::{
        Component, DialectInstructions, Elem, Instruction, Variable, unary,
        variable_to_frag,
    },
};
...
impl<M: DialectWmmaCompiler<Self>> DialectRudaBuiltins<Self> for HipDialect<M> {}
...
impl<M: DialectWmmaCompiler<Self>> DialectWmmaCompiler<Self> for HipDialect<M> {
    ...
    fn compile_wwma_fragment_ident(
        f: &mut std::fmt::Formatter<'_>,
        ident: &crate::cpp::shared::FragmentIdent<Self>,
    ) -> std::fmt::Result {
    ...
    fn compile_wmma_fragment_layout(
        f: &mut std::fmt::Formatter<'_>,
        layout: &crate::cpp::shared::FragmentLayout<Self>,
    ) -> std::fmt::Result {
    ...
    fn compile_wmma_fragment(
        f: &mut std::fmt::Formatter<'_>,
        fragment: &crate::cpp::shared::Fragment<Self>,
    ) -> std::fmt::Result {
    ...
    fn compile_wmma_instruction(
        f: &mut std::fmt::Formatter<'_>,
        instruction: &crate::cpp::shared::WmmaInstruction<Self>,
    ) -> std::fmt::Result {
    ...
    ) -> crate::cpp::shared::SupportedMmaCombinations {
