...
use crate::cpp::shared::{FP4Kind, FP8Kind};
...
pub enum Variable<D: Dialect> {
    ...
    UnitPosZ,
    RudaPos(Elem<D>),
    RudaPosBaseName, // base name for XYZ
    RudaPosX,
    RudaPosY,
    RudaPosZ,
    RudaDim,
    RudaDimBaseName, // base name for XYZ
    RudaDimX,
    RudaDimY,
    RudaDimZ,
    RudaCount(Elem<D>),
    RudaCountBaseName, // base name for XYZ
    RudaCountX,
    RudaCountY,
    RudaCountZ,
    PlaneDim,
...
impl<D: Dialect> Component<D> for Variable<D> {
    ...
    fn item(&self) -> Item<D> {
        match self {
            ...
            Variable::RudaCount(elem) => Item::scalar(*elem, true),
            Variable::RudaCountBaseName => Item {
                elem: Elem::U32,
                vectorization: 3,
                native: true,
            },
            Variable::RudaCountX => Item::scalar(Elem::U32, true),
            Variable::RudaCountY => Item::scalar(Elem::U32, true),
            Variable::RudaCountZ => Item::scalar(Elem::U32, true),
            Variable::RudaDimBaseName => Item {
                elem: Elem::U32,
                vectorization: 3,
                native: true,
            },
            Variable::RudaDim => Item::scalar(Elem::U32, true),
            Variable::RudaDimX => Item::scalar(Elem::U32, true),
            Variable::RudaDimY => Item::scalar(Elem::U32, true),
            Variable::RudaDimZ => Item::scalar(Elem::U32, true),
            Variable::RudaPos(elem) => Item::scalar(*elem, true),
            Variable::RudaPosBaseName => Item {
                elem: Elem::U32,
                vectorization: 3,
                native: true,
            },
            Variable::RudaPosX => Item::scalar(Elem::U32, true),
            Variable::RudaPosY => Item::scalar(Elem::U32, true),
            Variable::RudaPosZ => Item::scalar(Elem::U32, true),
            ...
            Variable::PlaneCount => Item::scalar(Elem::U32, true),
...
impl<D: Dialect> Display for Variable<D> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Variable::RudaCount(_) => D::compile_ruda_count(f),
            Variable::RudaCountBaseName => D::compile_ruda_count_base_name(f),
            Variable::RudaCountX => D::compile_ruda_count_x(f),
            Variable::RudaCountY => D::compile_ruda_count_y(f),
            Variable::RudaCountZ => D::compile_ruda_count_z(f),
            Variable::RudaDim => D::compile_ruda_dim(f),
            Variable::RudaDimBaseName => D::compile_ruda_dim_base_name(f),
            Variable::RudaDimX => D::compile_ruda_dim_x(f),
            Variable::RudaDimY => D::compile_ruda_dim_y(f),
            Variable::RudaDimZ => D::compile_ruda_dim_z(f),
            Variable::RudaPos(_) => D::compile_ruda_pos(f),
            Variable::RudaPosBaseName => D::compile_ruda_pos_base_name(f),
            Variable::RudaPosX => D::compile_ruda_pos_x(f),
            Variable::RudaPosY => D::compile_ruda_pos_y(f),
            Variable::RudaPosZ => D::compile_ruda_pos_z(f),
            ...
            Variable::PlaneCount => D::compile_plane_count(f),
...
impl<D: Dialect> Variable<D> {
    ...
    pub fn is_always_scalar(&self) -> bool {
        match self {
            ...
            Variable::RudaCount(_) => true,
            Variable::RudaCountBaseName => false,
            Variable::RudaCountX => true,
            Variable::RudaCountY => true,
            Variable::RudaCountZ => true,
            Variable::RudaDim => true,
            Variable::RudaDimBaseName => false,
            Variable::RudaDimX => true,
            Variable::RudaDimY => true,
            Variable::RudaDimZ => true,
            Variable::RudaPos(_) => true,
            Variable::RudaPosBaseName => true,
            Variable::RudaPosX => true,
            Variable::RudaPosY => true,
            Variable::RudaPosZ => true,
