...
use crate::cpp::{
    ...
    shared::{
        self, Component, DialectBindings, DialectRudaBuiltins, DialectIncludes,
        DialectInstructions, DialectTypes, DialectWarpReduceCompiler,
    ...
    fn compile_elem(
        ...
        if words {
            ...
            match elem {
                ...
                shared::Elem::Barrier(BarrierLevel::Ruda) => {
...
impl<M: DialectWmmaCompiler<Self>> DialectRudaBuiltins<Self> for CudaDialect<M> {
