...
use ruda_core::ir::{Instruction, Processor, Scope};
use std::rc::Rc;
...
impl OptimizerBuilder {
    ...
    pub fn optimize(self, expand: Scope, ruda_dim: RudaDim) -> Optimizer {
        Optimizer::new(expand, ruda_dim, self.transformers, self.processors)
    }
}
