...
use ruda_core::{launch::RudaDim, arguments::Info, ir::Id, kernel::Visibility};
use std::fmt::Display;
...
",
        ...
        if self.num_subgroups {
            f.write_str("    @builtin(num_subgroups) num_subgroups: u32,\n")?;
        }
