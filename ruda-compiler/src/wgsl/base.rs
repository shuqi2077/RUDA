use crate::wgsl::Item::Scalar;
use ruda_core::ir::{ConstantValue, Id};
use std::fmt::Display;
...
impl Variable {
    ...
    pub fn item(&self) -> Item {
        match self {
            ...
            Self::NumSubgroups => Item::Scalar(Elem::U32),
...
impl Display for Variable {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Variable::NumSubgroups => f.write_str("num_subgroups"),
