use ruda_core::{ir::StorageType, kernel::KernelDefinition};
...
use super::{shared_memories::SharedMemories, visitor::Visitor};
...
impl<'a> Module<'a> {
    pub fn new(context: &'a Context, name: String) -> Self {
