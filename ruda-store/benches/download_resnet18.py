...
def download_resnet18():
    ...
    temp_dir = Path(tempfile.gettempdir()) / "ruda_resnet18_benchmark"
    ...
    try:
        ...
        # Save the model state dict (this is what ruda-store reads)
...
def main():
    ...
    bench_config = Path(tempfile.gettempdir()) / "ruda_resnet18_benchmark" / "path.txt"
