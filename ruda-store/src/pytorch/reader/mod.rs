...
use alloc::vec::Vec;
use ruda_model::record::serde::{adapter::DefaultAdapter, data::NestedValue, de::Deserializer};
...
pub enum PytorchError {
    ...
    Serde(ruda_model::record::serde::error::Error),
}
...
impl From<ruda_model::record::serde::error::Error> for PytorchError {
    fn from(e: ruda_model::record::serde::error::Error) -> Self {
...
/// # Example
/// ```rust,no_run
/// # use ruda_store::pytorch::PytorchReader;
...
mod value;
use value::{read_pickle_as_value, convert_pickle_to_nested_value};
