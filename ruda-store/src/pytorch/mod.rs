//! PyTorch format support for ruda-store.
//!
//! This module provides comprehensive support for loading PyTorch model files (.pth, .pt)
//! into Ruda, with automatic weight transformation and flexible configuration options.
//!
//! ## Features
//!
//! - **Direct .pth/.pt file loading**: Load PyTorch checkpoint and state dict files
//! - **Automatic weight transformation**: `PyTorchToRudaAdapter` is applied by default:
...
//!
//! // Load a PyTorch model (PyTorchToRudaAdapter is applied automatically)
