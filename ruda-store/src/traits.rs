...
///
/// This trait provides convenient methods to collect and apply tensor snapshots from any Ruda module.
...
pub trait ModuleStore {
    ...
    ///
    /// ```rust,ignore
    /// let mut store = RudapackStore::from_file("model.bpk");
