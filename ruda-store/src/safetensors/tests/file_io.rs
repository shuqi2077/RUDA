...
use ruda_nn::{Initializer, LinearConfig};
...
#[derive(Module, Debug)]
struct ForwardTestModel<B: ruda_tensor::api::backend::Backend> {
    linear1: ruda_nn::Linear<B>,
    linear2: ruda_nn::Linear<B>,
}

impl<B: ruda_tensor::api::backend::Backend> ForwardTestModel<B> {
...
impl ForwardTestModelConfig {
    fn init<B: ruda_tensor::api::backend::Backend>(&self, device: &B::Device) -> ForwardTestModel<B> {
        ForwardTestModel {
