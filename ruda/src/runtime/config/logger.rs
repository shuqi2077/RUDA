use super::{RudaRuntimeConfig, RuntimeConfig};
...
use ruda_core::config::logger::LoggerSinks;
pub(crate) use ruda_core::config::logger::{LogLevel, LoggerConfig};

/// Central logging utility for `Ruda`, managing multiple log outputs.
#[derive(Debug)]
pub struct Logger {
    sinks: LoggerSinks,
    ...
    pub config: Arc<RudaRuntimeConfig>,
}
