...
fn load_autotune_level() -> u32 {
    ...
    if autotune_level == -1 {
        ...
        let level = match config.autotune.level {
            crate::runtime::config::autotune::AutotuneLevel::Minimal => 0,
            crate::runtime::config::autotune::AutotuneLevel::Balanced => 1,
            crate::runtime::config::autotune::AutotuneLevel::Extensive => 2,
            crate::runtime::config::autotune::AutotuneLevel::Full => 3,
        };
