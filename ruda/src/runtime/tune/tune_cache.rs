...
#[cfg(std_io)]
use ruda_core::cache::Cache;
#[cfg(std_io)]
use ruda_core::cache::CacheError;
#[cfg(std_io)]
...
impl<K: AutotuneKey> TuneCache<K> {
    pub(crate) fn new(
        ...
        #[cfg(std_io)]
        {
            ...
            let root = crate::runtime::config::RudaRuntimeConfig::get()
                .autotune
                .cache
                .root();
            let options = ruda_core::cache::CacheOption::default();
