use alloc::vec::Vec;
use ruda_tensor::backend::ExecutionError;
use ruda_tensor::{Scalar, tensor::FloatElem};
use ruda_core::tensor::{BoolDType, IntDType};

use crate::{BackendRouter, RunnerChannel, RunnerClient, get_client};
use ruda_tensor::tensor::{BoolTensor, Device, FloatTensor, IndexingUpdateOp, IntTensor};
use ruda_tensor::{Distribution, FloatDType, Shape, Slice, TensorData, ops::FloatTensorOps};
