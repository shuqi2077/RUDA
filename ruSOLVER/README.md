...
Source: [LU](src/lu.rs), [QR](src/qr.rs), [SVD](src/svd.rs), and [CG](src/iterative.rs).
...
Source: [Device Cholesky](src/tensor/mod.rs) and [additional device solvers](src/tensor/advanced.rs).
...
Source: [Distributed CG](src/distributed.rs) and [pullbacks](src/adjoint.rs).
