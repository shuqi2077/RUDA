...
[English](../../en/libraries/rusparse.md) | [简体中文](../../zh/libraries/rusparse.md) | **日本語** | [Deutsch](../../de/libraries/rusparse.md) | [Русский](../../ru/libraries/rusparse.md)

[計算ライブラリ](README.md) · [中文](../../zh/libraries/rusparse.md)
...
API 参照: [デバイス CSR](../../../ruSPARSE/src/tensor/mod.rs)、[フレームワーク CSR](../../../ruda-tensor/src/api/sparse.rs)。
