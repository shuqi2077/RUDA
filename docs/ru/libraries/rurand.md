...
[English](../../en/libraries/rurand.md) | [简体中文](../../zh/libraries/rurand.md) | [日本語](../../ja/libraries/rurand.md) | [Deutsch](../../de/libraries/rurand.md) | **Русский**

[Вычислительные библиотеки](README.md) · [Среда выполнения API](../runtime-api.md) · [中文](../../zh/libraries/rurand.md)
...
Пакет Cargo — `ruRAND`; его имя для импорта в Rust — `rurand`. Функция `tensor` включает тензорные интерфейсы устройств. В этой конфигурации каталог приложения размещается рядом с исходным каталогом `RUDA`. См. раздел [Начало работы](../getting-started.md) для настройки NVIDIA.
...
API Ссылка: [Тензорные интерфейсы](../../../ruRAND/src/tensor/mod.rs), [Исходное состояние](../../../ruRAND/src/state.rs), [Распределения](../../../ruRAND/src/distributions/mod.rs).
