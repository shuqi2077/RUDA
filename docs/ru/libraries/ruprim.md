...
[English](../../en/libraries/ruprim.md) | [简体中文](../../zh/libraries/ruprim.md) | [日本語](../../ja/libraries/ruprim.md) | [Deutsch](../../de/libraries/ruprim.md) | **Русский**

[Вычислительные библиотеки](README.md) · [Тензорная платформа](../tensor-framework.md) · [中文](../../zh/libraries/ruprim.md)
...
В этой конфигурации каталог приложения размещается рядом с исходным каталогом `RUDA`. См. раздел [Начало работы](../getting-started.md) для настройки NVIDIA.
...
API Ссылка: [Сокращение](../../../ruPRIM/src/reduce/tensor/base.rs), [Сканирование](../../../ruPRIM/src/scan/tensor.rs), [Индексирование](../../../ruPRIM/src/indexing/mod.rs), [Целые степени](../../../ruPRIM/src/elementwise/binary/integer_power.rs).
