...
[English](../../en/libraries/rudnn.md) | [简体中文](../../zh/libraries/rudnn.md) | [日本語](../../ja/libraries/rudnn.md) | [Deutsch](../../de/libraries/rudnn.md) | **Русский**

[Вычислительные библиотеки](README.md) · [ruBLAS](rublas.md) · [Тензоры и платформы](../tensor-framework.md) · [中文](../../zh/libraries/rudnn.md)
...
| `tensor-paged-attention` | Постраничные MHA/GQA/MLA |
...
Внимание и свертка имеют соответствующие функции автонастройки. См. [Cargo.toml](../../../ruDNN/Cargo.toml) и [экспорт модуля](../../../ruDNN/src/lib.rs).
...
Сопоставьте макет, маску и точность с выбранной стратегией. См. [интерфейс внимания](../../../ruDNN/src/attention/tensor/base.rs).
...
Один и тот же модуль предоставляет conv_data_backward и conv_weight_backward. Проверьте форму, варианты и требования к исполнению для каждого направления. См. [интерфейс свертки](../../../ruDNN/src/convolution/tensor/base.rs).
...
Источник: [маршрутизация](../../../ruDNN/src/moe/routing.rs), [отправка и объединение](../../../ruDNN/src/moe/dispatch.rs), [эксперты](../../../ruDNN/src/moe/experts.rs) и [тесты](../../../ruDNN/src/moe/tests.rs).
...
Для вызовов текста и изображений на уровне модели см. [Руководство по выводу ruLLM](../model-inference.md).
