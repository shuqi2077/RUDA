...
[English](../../en/libraries/rurand.md) | [简体中文](../../zh/libraries/rurand.md) | [日本語](../../ja/libraries/rurand.md) | **Deutsch** | [Русский](../../ru/libraries/rurand.md)

[Compute-Bibliotheken](README.md) · [Laufzeit API](../runtime-api.md) · [中文](../../zh/libraries/rurand.md)
...
Das Cargo-Paket ist `ruRAND`; Sein Rust-Importname ist `rurand`. Die Funktion `tensor` ermöglicht Geräte-Tensor-Schnittstellen. Bei dieser Konfiguration wird das Anwendungsverzeichnis neben dem Quellverzeichnis `RUDA` platziert. Informationen zum NVIDIA-Setup finden Sie unter [Erste Schritte](../getting-started.md).
...
API Referenz: [Tensorschnittstellen](../../../ruRAND/src/tensor/mod.rs), [Seed-Status](../../../ruRAND/src/state.rs), [Verteilungen](../../../ruRAND/src/distributions/mod.rs).
