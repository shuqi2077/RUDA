...
use ruda_kernel::tensor::unary_numeric::{NumericUnaryOp, NumericUnaryOpFamily, launch_unary_numeric};
use ruprim::elementwise::binary::int::{BitwiseShlOp, BitwiseShrOp, launch_binop_int, launch_scalar_binop_int};
use ruprim::elementwise::unary::int::unary_basic_int;
...
use ruda_tensor::{DType, IntDType, Slice, ops::IntTensorOps};
use ruda_tensor::{Distribution, ElementConversion, Shape, TensorData, get_device_settings};
use ruda_tensor::{ExecutionError, Scalar};
use ruda_core::tensor::{BoolDType, FloatDType};
...
impl<R, F, I, BT> IntTensorOps<Self> for DeviceBackend<R, F, I, BT>
where
    R: DeviceRuntime,
    F: FloatElement,
    I: IntElement,
    BT: BoolElement,
{
    ...
    fn bitwise_left_shift(lhs: IntTensor<Self>, rhs: IntTensor<Self>) -> IntTensor<Self> {
        launch_binop_int::<R, ruprim::elementwise::binary::int::BitwiseShlOp>(lhs, rhs)
    }
